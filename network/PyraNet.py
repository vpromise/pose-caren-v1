...
class PyraNet(nn.Module):
	...
	def __init__(self, nChannels=256, nStack=4, nModules=2, numReductions=4, baseWidth=6, cardinality=30, nJoints=16, inputRes=256):
		...
		self.res1 = ResidualPyramid(64, 128, self.inputRes//2, self.baseWidth, self.cardinality, 0)
		self.mp = nn.MaxPool2d(2, 2)
		self.res2 = ResidualPyramid(128, 128, self.inputRes//4, self.baseWidth, self.cardinality,)
		self.res3 = ResidualPyramid(128, self.nChannels, self.inputRes//4, self.baseWidth, self.cardinality)
